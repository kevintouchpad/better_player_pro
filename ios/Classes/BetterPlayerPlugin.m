    ...
    if ([@"init" isEqualToString:call.method]) {
        ...
        if ([@"setDataSource" isEqualToString:call.method]) {
            ...
            if (assetArg) {
                ...
                [player setDataSourceURL:[NSURL URLWithString:uriArg] withKey:key withHeaders:headers withCache: useCache cacheKey:cacheKey cacheManager:_cacheManager overriddenDuration:overriddenDuration videoExtension: videoExtension];
            } else {
